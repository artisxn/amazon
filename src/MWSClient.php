...
namespace codicastudio\LaravelAmazonMWS;

use GuzzleHttp\Client;
use codicastudio\LaravelAmazonMWS\Exceptions\CountryIsMissingException;
use codicastudio\LaravelAmazonMWS\Exceptions\CountryNotAvailableException;
...
class MWSClient
{
    ...
    const APPLICATION_NAME = 'codicastudio/MwsClient';
